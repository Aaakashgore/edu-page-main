...
import rema from './Akash Gore.pdf';
            ...
            <div className="jumbotron">
                ...
                <div className='details' >
                    <div className="lead" >
                        ...
                        <p className='book-details'>Akash | 557 Pages | 18.4 MB | English</p>
                    </div>
                    <div className="lead">
                        <a className="btn btn-primary btn-lg" href={rema} role="button"download ="Akash Gore.pdf">Download</a>
                    </div>
                </div>
            </div>
            <div className="jumbotron">
                ...
                <div className='details' >
                    ...
                    <p className="lead">
                        <a className="btn btn-primary btn-lg" href={cormen} role="button"download ="Intro-Algorithm.pdf">Download</a>
                    </p>
                </div>
            </div>
         </div>
